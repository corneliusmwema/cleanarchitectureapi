...
namespace Application.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<AuthResponse> LoginUser(UserLoginDto loginUserDto)
        {
            ...
            bool checkPassword = BCrypt.Net.BCrypt.Verify(loginUserDto.Password, userExists.Password);
        ...
        {
            List<string> allowedFileExt = new List<string> { ".PNG", ".png", ".jpg", ".jpeg", ".tiff", ".gif", ".JPEG", ".JPG", ".TIFF", ".GIF" };
