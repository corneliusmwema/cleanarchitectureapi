...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        try
        {
            ...
            if (logger != null) logger.LogInformation("Database connection successfully configured.");
        }
        catch (Exception ex)
        {
            if (logger != null) logger.LogError(ex, "An error occurred while configuring the database connection.");
